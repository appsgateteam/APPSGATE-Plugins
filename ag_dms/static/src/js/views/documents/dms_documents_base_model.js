...
odoo.define('ag_dms_views.DocumentsModel', function(require) {
"use strict";
...
var DocumentsModel = Class.extend(mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    _loadNode: function(node, args) {
    	var self = this;
    	var result = $.Deferred();
    	if(node.data && node.data.odoo_model === "ag_dms.directory") {
