...
odoo.define('ag_preview_markdown.PreviewContentVector', function (require) {
"use strict";
...
var PreviewContentVector = AbstractPreviewContent.extend({
	...
	template: "ag_preview.PreviewContentVector",    
    jsLibs: [
        '/ag_web_preview_image/static/lib/svg-pan-zoom/svg-pan-zoom.js',
    ],
	willStart: function() { 
		var def = $.ajax({
		  url: this.url,
