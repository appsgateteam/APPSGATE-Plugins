...
odoo.define('ag_dms_share.dialog', function(require) {
"use strict";

var core = require('web.core');
var session = require('web.session');

var ShareDialog = require('ag_web_share.dialog');
    ...
    formatUrl: function(url) {
    	if(this.__parentedParent && this.__parentedParent.state) {
    		...
    		if(model === 'ag_dms.file') {
    			...
    			return $(QWeb.render('ag_dms_share.FileLink', {
                    widget: this,
                    session: session, 
                    name: data.name || url,
                    url: url,
