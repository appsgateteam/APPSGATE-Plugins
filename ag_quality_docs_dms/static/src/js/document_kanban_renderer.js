...
odoo.define('ag_quality_docs_dms.DocumentKanbanRenderer', function (require) {
"use strict";
...
var DocumentKanbanRenderer = require('ag_quality_docs.DocumentKanbanRenderer');
    ...
    _preview: function(ev) {
    	...
    	this.trigger_up('show_preview', {
    		url: '/web/content?' + $.param({
    			'model': "ag_quality_docs.document",
