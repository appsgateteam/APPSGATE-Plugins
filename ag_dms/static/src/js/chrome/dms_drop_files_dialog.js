...
odoo.define('ag_dms_dialogs.DocumentDropFilesDialog', function(require) {
"use strict";
...
var DocumentDropDialog = require('ag_dms_dialogs.DocumentDropDialog');
...
var DocumentDropFilesDialog = DocumentDropDialog.extend({
	init: function (parent, options) {
    	...
    	this._super(parent, _.extend({}, {
            ...
            $content: $(QWeb.render("ag_dms.DocumentDropFilesDialog", {
