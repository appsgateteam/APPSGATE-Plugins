...
odoo.define('ag_dms_view.DocumentsMainView', function(require) {
"use strict";
...
var ActionDocumentTreeView = require('ag_dms_view.ActionDocumentTreeView');
...
var DocumentTreeMainView = ActionDocumentTreeView.extend({
	cssLibs: [
        '/ag_dms_view/static/library/jquery-splitter/css/jquery.splitter.css',
    ],
    jsLibs: [
        '/ag_dms_view/static/library/jquery-splitter/js/jquery.splitter.js',
    ],
...
core.action_registry.add('ag_dms_view.documents', DocumentTreeMainView);
