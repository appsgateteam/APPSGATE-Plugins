...
odoo.define('ag_dms_action.KanbanFileActions', function (require) {
"use strict";
...
var AbstractFileActions = require('ag_dms_action.AbstractFileActions');
...
var KanbanFileActions = AbstractFileActions.extend({
    ...
    _render: function () {
    	if (this.value && this.value.count >= 1) {
			...
			this.$el.html(QWeb.render("ag_dms_actions.KanbanFileActions", {
