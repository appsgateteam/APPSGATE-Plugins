...
from odoo.addons.ag_dms.tests import dms_case
...
class DirectoryTestCase(dms_case.DMSTestCase):
    ...
    def test_compute_thumbnail(self):
        directory = self.browse_ref("ag_dms.directory_01_demo")
        self.assertTrue(directory.thumbnail)
        
    def test_create_directory(self):
        settings = self.browse_ref("ag_dms.settings_demo")
    ...
    def test_copy_root_directory(self):
        root_directory = self.browse_ref("ag_dms.directory_01_demo")
    ...
    def test_copy_sub_directory(self):
        sub_directory = self.browse_ref("ag_dms.directory_03_demo")
