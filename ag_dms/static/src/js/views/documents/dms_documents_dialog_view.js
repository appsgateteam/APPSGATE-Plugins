...
odoo.define('ag_dms_views.DocumentTreeDialogView', function(require) {
"use strict";
...
var DocumentsDialogController = require('ag_dms_views.DocumentsDialogController');

var _t = core._t;
var QWeb = core.qweb;

var DocumentTreeDialogView = Widget.extend({
	template: 'ag_dms.DocumentDialog',
