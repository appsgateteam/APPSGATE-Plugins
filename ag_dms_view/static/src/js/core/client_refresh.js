...
odoo.define('ag_dms_view.client_refresh.channel', function (require) {
"use strict";
...
WebClient.include({
    refresh: function(message) {
    	...
    	if (!this.call('bus_service', 'isMasterTab') || session.uid !== message.uid && 
    			(message.model === 'ag_dms.directory' || message.model === 'ag_dms.file'),
    			action && controller && controller.widget && action.tag === "ag_dms_view.documents") {
