...
odoo.define('ag_dms_views.DocumentsViewController', function(require) {
"use strict";
...
var DocumentsController = require('ag_dms_views.DocumentsController');
    	...
    	menu.create = {
			...
			submenu: {
				directory: {
					...
					icon: "fa fa-folder-o",
					action: function(data) {
						self._createNode(node, "ag_dms.directory");
					},
					_disabled: function (data) {
		    			return !node.data.perm_create;
	    			},
				...
				file : {
					...
					icon: "fa fa-file-o",
					action: function(data) {
						self._createNode(node, "ag_dms.file");
					},
					_disabled: function (data) {
		    			return !node.data.perm_create;
	    			},
