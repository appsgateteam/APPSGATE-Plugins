...
odoo.define('ag_dms_views.FileKanbanRenderer', function (require) {
"use strict";
...
var FileKanbanColumn = require('ag_dms_views.FileKanbanColumn');
var FileKanbanRecord = require('ag_dms_views.FileKanbanRecord');
    ...
    _renderView: function () {
    	...
    	if(!config.device.isMobile && _.some(_.keys(this.kanban_sidebar), function(key) {
    		...
    		this.sidebar = $("<div>", {
	    		...
	    		html: $(QWeb.render('ag_dms.KanbanFileSidebar', {
	                widget: this,
