            ...
            for line in self.depreciation_line_ids:
                if line.move_check:
                    if not line.move_id.state == 'posted':
                        raise Warning(_('Please post the move of all depreciation lines.'))
...
# 
    ...
    def disposal_gain_loss(self):
        ...
        if not self.disposal_partner_id:
            raise Warning(_('Please select disposal customer!'))
        if not self.disposal_invoice_id:
            raise Warning(_('Please select customer invoice!'))
