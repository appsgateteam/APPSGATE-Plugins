...
from odoo.addons.ag_dms.tests.common import DocumentsBaseCase
...
class FileTestCase(DocumentsBaseCase):
    ...
    def _setup_test_data(self):
        ...
        self.directory_root_demo_01 = self.browse_ref("ag_dms.directory_01_demo")
        self.directory_root_demo_02 = self.browse_ref("ag_dms.directory_02_demo")
        self.directory_root_demo_03 = self.browse_ref("ag_dms.directory_03_demo")
        self.directory_sub_demo_01 = self.browse_ref("ag_dms.directory_11_demo")
        self.directory_sub_demo_02 = self.browse_ref("ag_dms.directory_12_demo")
        self.file_demo_01 = self.browse_ref("ag_dms.file_01_demo")
        self.file_demo_02 = self.browse_ref("ag_dms.file_02_demo")
        self.file_demo_03 = self.browse_ref("ag_dms.file_03_demo")
        self.file_demo_04 = self.browse_ref("ag_dms.file_04_demo")
        self.file_demo_05 = self.browse_ref("ag_dms.file_05_demo")
