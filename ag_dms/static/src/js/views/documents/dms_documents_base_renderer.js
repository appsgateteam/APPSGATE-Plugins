...
odoo.define('ag_dms_views.DocumentsRenderer', function(require) {
"use strict";
...
var DocumentsRenderer = Widget.extend({
	xmlDependencies: [
		'/ag_dms/static/src/xml/dms_documents_tree.xml'
	],
	cssLibs: [
        '/ag_web_utils/static/lib/jsTree/themes/proton/style.css',
    ],
    jsLibs: [
        '/ag_web_utils/static/lib/jsTree/jstree.js',
    ],
    ...
    start: function() {
    	...
    	this.$tree.on('open_node.jstree', function (e, data) {
    		if(data.node.data && data.node.data.odoo_model === "ag_dms.directory") {
