...
class AssetDepreciationConfirmationWizard(models.TransientModel):
    _name = "asset.depreciation.confirmation.wizard.custom"
    _description = "asset.depreciation.confirmation.wizard.custom"
    ...
    def asset_compute(self):
        ...
        created_move_ids = self.env['account.asset.asset.custom'].compute_generated_entries(self.date, asset_type=context.get('asset_type'))
