...
odoo.define('ag_quality_docs.DocumentListRenderer', function (require) {
"use strict";
...
var DocumentListRenderer = ListRenderer.extend({
    ...
    _renderSidebar: function () {
    	...
    	if(!config.device.isMobile) {
    		this.sidebar = $("<div>", {
	    		...
	    		html: $(QWeb.render('ag_quality_docs.ListDocumentSidebar', {
	                widget: this,
    ...
    _load_kanban_sidebar_data: function() {
    	var self = this;
    	return this._rpc({
            route: '/sidebar/ag_quality_docs_document/list',
