...
class DocumentsBaseCase(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.storage = self.env['ag_dms.storage']
        self.directory = self.env['ag_dms.directory']
        self.file = self.env['ag_dms.file']
        self.category = self.env['ag_dms.category']
        self.tag = self.env['ag_dms.tag']
    ...
    def _load(self, module, *args):
        convert_file(self.cr, 'ag_dms', get_module_resource(module, *args),
