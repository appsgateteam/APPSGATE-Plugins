...
odoo.define('ag_dms_dialogs.DocumentDropDialog', function(require) {
"use strict";
...
var DocumentDropDialog = Dialog.extend({
	cssLibs: [
        '/ag_web_utils/static/lib/dropzone/dropzone.css',
    ],
    jsLibs: [
        '/ag_web_utils/static/lib/dropzone/dropzone.js',
    ],
