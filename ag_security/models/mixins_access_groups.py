...
class AccessGroupsModel(models.AbstractModel):
    ...
    _name = 'ag_security.mixins.access_groups'
    _description = "Group Access Mixin"
    _inherit = 'ag_security.mixins.access_rights'
    ...
    def _add_magic_fields(self):
        ...
        add('groups', fields.Many2many(
            ...
            comodel_name='ag_security.access_groups',
    ...
    def _apply_access_groups(self, query, mode='read'):
        ...
        where_clause = '''
            "{table}".id IN ( 
                ...
                JOIN ag_security_access_groups g ON r.gid = g.id 
                JOIN ag_security_access_groups_users_rel u ON r.gid = u.gid 
