...
odoo.define('ag_quality_docs.DocumentKanbanRenderer', function (require) {
"use strict";
...
var DocumentKanbanRenderer = KanbanRenderer.extend({
    ...
    _renderSidebar: function () {
    	...
    	if(!config.device.isMobile) {
    		this.sidebar = $("<div>", {
	    		...
	    		html: $(QWeb.render('ag_quality_docs.KanbanDocumentSidebar', {
	                widget: this,
    ...
    _load_kanban_sidebar_data: function() {
    	var self = this;
    	return this._rpc({
            route: '/sidebar/ag_quality_docs_document/kanban',
