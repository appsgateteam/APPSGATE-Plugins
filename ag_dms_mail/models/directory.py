...
from odoo.addons.ag_utils.tools.file import slugify
from odoo.addons.ag_utils.tools.file import unique_name
...
class Directory(models.Model):
    ...
    def get_alias_model_name(self, vals):
        return vals.get('alias_model', 'ag_dms.directory')
