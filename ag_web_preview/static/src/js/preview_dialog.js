...
odoo.define('ag_preview.PreviewDialog', function (require) {
"use strict";
...
var PreviewHandler = require('ag_preview.PreviewHandler');
var PreviewGenerator = require('ag_preview.PreviewGenerator');
...
var PreviewDialog = Widget.extend({
    ...
    jsLibs: [
        '/ag_web_utils/static/lib/printThis/printThis.js',
    ],
