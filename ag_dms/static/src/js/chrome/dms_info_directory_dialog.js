...
odoo.define('ag_dms_dialogs.DocumentDirectoryInfoDialog', function(require) {
"use strict";

var core = require('web.core');

var DocumentInfoDialog = require('ag_dms_dialogs.DocumentInfoDialog');
...
var DocumentDirectoryInfoDialog = DocumentInfoDialog.extend({
    init: function (parent, options) {
        ...
        this._super(parent, _.extend({}, {
            ...
            qweb: "ag_dms.DocumentDirectoryInfoDialog",
        }, this.options));
    },
});
