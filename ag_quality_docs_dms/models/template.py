...
class Template(models.Model):
    ...
    _inherit = "ag_quality_docs.template"
    ...
    def _get_document_file_directory(self):
        try:
            ...
            file_directory = get_param("ag_quality_docs_dms.template_file_directory")
        except:
            try:
    ...
    def _get_document_viewer_file_directory(self):
        try:
            get_param = self.env["ir.config_parameter"].sudo().get_param
            viewer_file_directory = get_param("ag_quality_docs_dms.template_viewer_file_directory")
        except:
            try:
                get_param = self["ir.config_parameter"].sudo().get_param
                viewer_file_directory = get_param("ag_quality_docs_dms.template_viewer_file_directory")
